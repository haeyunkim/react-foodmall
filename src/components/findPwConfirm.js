...
const FindPwConfirm = ({ email }) => {
  ...
  return (
    <>
      {findPwConfirmModal ? (
        <div className="findPwConfirm-wrapper">
          <section className="newPw-container">
            <div className="findPwConfirm-title-wrapper">
              <img
                className="findPwConfirm-daejeon"
                ...
                width="10%"
              />
              <h2 className="findid-title">비밀번호 재설정하기</h2>
            ...
            <form>
              <div id="findPwConfirm-wrapper">
                <TextField
                  onKeyPress={handleEnter}
                  onChange={onChangePassWord}
                  margin="normal"
                  className="findPwConfirm-input"
                  label="새 비밀번호를 입력하세요"
                  required
                  fullWidth
                  type="password"
            ...
            <div className="findPwConfirm-btn-wrapper">
              <Button
                id="findPwConfirm-btn"
                type="submit"
                fullWidth
                variant="contained"
                sx={{ mt: 3, mb: 2 }}
