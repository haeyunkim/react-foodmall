  ...
  return (
    <div className="main">
      <Navbar id="navbar-wrapper">
        <Container>
          <Navbar.Brand id="taste-daejeon-wrapper" onClick={clickHome}>
            <img
              className="taste-daejeon"
              ...
              width="15%"
            />
            <span className="daejeon-taste">대전의 맛</span>
          </Navbar.Brand>
          <div className="main-nav-item-wrapper">
            <Nav className="me-auto">
              ...
              <Nav.Link id="main-nav-item-2" onClick={clickList}>
                맛집리스트
              </Nav.Link>
              {loginStatus ? (
                <>
