    ...
    <>
      {findIdModal ? (
        <div className="findid-wrapper">
          <section className="findid-container container">
            <div className="findid-title-wrapper">
              <div className="findid-title-item1">
                <img
                  className="findid-taste-daejeon"
            ...
            <div className="findid-text-wrapper">
              <form>
